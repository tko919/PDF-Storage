...
\define $C^\infty$ 級関数 $r:M \supset U \to \R$ が\textbf{距離関数}であるとは、$|\nabla r| \equiv 1$ を満たすことである。このとき、上の命題の結果は $|\Hess r|^2+\nabla r(\Delta r)=-\Ric(\nabla r,\nabla r)$ となる。
...
% TODO:
% short time existence(deTurck Trick)
% maximum principle
% long time existence
% compactness theorem
...
\begin{thebibliography}{9}
    ...
    \bibitem{chow} CHOW, Bennett; LU, Peng; NI, Lei. Hamilton's Ricci flow. American Mathematical Soc., 2006.
\end{thebibliography}
